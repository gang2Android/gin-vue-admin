...
type News struct {
	...
	User_img      string `json:"user_img" form:"user_img" gorm:"column:user_img;comment:会员头像;type:varchar(50);size:50;"`
	...
	Img_main      string `json:"img_main" form:"img_main" gorm:"column:img_main;comment:主图/预览图;type:varchar(50);size:50;"`
	...
	Imgs_url      string `json:"imgs_url" form:"imgs_url" gorm:"column:imgs_url;comment:图片地址,多个以逗号分隔(,);type:varchar(255);size:255;"`
	Video_url     string `json:"video_url" form:"video_url" gorm:"column:video_url;comment:视频地址;type:varchar(255);size:255;"`
