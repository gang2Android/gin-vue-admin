...
type Member struct {
	...
	PwdLogin int    `json:"pwd_login" form:"pwd_login" gorm:"column:pwd_login;comment:登录密码;type:varchar;size:255;"`
	PwdPay   int    `json:"pwd_pay" form:"pwd_pay" gorm:"column:pwd_pay;comment:支付密码;type:varchar;size:255;"`
	Img      int    `json:"img" form:"img" gorm:"column:img;comment:头像地址;type:varchar;size:255;"`
}
