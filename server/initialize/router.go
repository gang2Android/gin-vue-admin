...
import (
	...
	routerApp "gin-vue-admin/router/app"
	"net/http"
...
func Routers() *gin.Engine {
	...
	PrivateGroup.Use(middleware.JWTAuth()).Use(middleware.CasbinHandler())
	{
		...
		router.InitMemberRouter(PrivateGroup)
		router.InitMemberLevelRouter(PrivateGroup)
		// Code generated by gin-vue-admin End; DO NOT EDIT.
	}

	AppPublicGroup := Router.Group("app")
	{
		routerApp.InitBaseRouter(AppPublicGroup)
	}
	AppPrivateGroup := Router.Group("app")
	AppPrivateGroup.Use(middleware.JWTAuthApp())
	{
		routerApp.InitMemberRouter(AppPrivateGroup)
	}
