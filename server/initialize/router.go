...
func Routers() *gin.Engine {
	...
	PrivateGroup.Use(middleware.JWTAuth()).Use(middleware.CasbinHandler())
	{
		...
		router.InitAddressRouter(PrivateGroup)
		router.InitRegionRouter(PrivateGroup)
		router.InitNewsRouter(PrivateGroup)
		router.InitNewsClassifyRouter(PrivateGroup)
		router.InitNewsCommentsRouter(PrivateGroup)
