    ...
    <el-table-column label="状态" prop="status" width="120"></el-table-column> 
      ...
      <el-table-column label="按钮组">
        <template slot-scope="scope">
          <el-button class="table-button" @click="updateMember(scope.row)" size="small" type="primary" icon="el-icon-edit">变更</el-button>
...
export default {
  ...
  methods: {
    ...
    async enterDialog() {
      ...
      switch (this.type) {
        case "create":
          res = await createMember(this.formData);
          break;
        case "update":
          res = await updateMember(this.formData);
          break;
        default:
          res = await createMember(this.formData);
          break;
